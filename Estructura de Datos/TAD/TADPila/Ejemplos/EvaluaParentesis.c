...
COMPILACIÓN: 	gcc -o EvaluaParentesis EvaluaParentesis.c TADPila(Din|Est).o (Si se tiene el objeto de la implementación)
				gcc -o EvaluaParentesis EvaluaParentesis.c TADPila(Din|Est).c (Si se tiene el fuente de la implementación)
